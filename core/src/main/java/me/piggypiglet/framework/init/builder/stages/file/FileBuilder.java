...
public final class FileBuilder<R> extends AbstractBuilder<List<FileData>, R> {
    private final List<FileData> files = new ArrayList<>();

    @NotNull
    public FileBuilder<R> config(@NotNull final String name, @NotNull final String internalPath,
                                 @NotNull final String externalPath) {
        return config(name, internalPath, externalPath, Names.named(name));
    }

    @NotNull
    public FileBuilder<R> config(@NotNull final String name, @NotNull final FileData.ConfigPathReference internalPath,
                                 @NotNull final String externalPath) {
        return config(name, internalPath, externalPath, Names.named(name));
    }
    ...
    @NotNull
    public FileBuilder<R> file(@NotNull final String name, @NotNull final String internalPath,
                                 @NotNull final String externalPath) {
        return file(name, internalPath, externalPath, Names.named(name));
    }

    @NotNull
    public FileBuilder<R> file(@NotNull final String name, @NotNull final FileData.ConfigPathReference internalPath,
                                 @NotNull final String externalPath) {
        return file(name, internalPath, externalPath, Names.named(name));
    }
    ...
    @NotNull
    private FileBuilder<R> data(final boolean config, @NotNull final String name,
    ...
    @Override
    protected List<FileData> provideBuild() {
        return files;
    }
}
